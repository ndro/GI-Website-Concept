        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-center" >
                    <a href="<?php bloginfo('url'); ?>/berita" class="btn btn-success btn-lg">Lihat Semua Berita</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <a href="all-news.html" class="btn btn-success btn-lg">Lihat Laporan Keuangan</a>
                </div>
            </div>
        </div>
    </section>
